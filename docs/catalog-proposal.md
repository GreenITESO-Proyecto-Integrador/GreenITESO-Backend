...
referencia y hora; permite iconos opcionales. Para clanes en una fixture
`APPROVED`, exige descripción y `career` no vacíos; también rechaza colisiones
con filas de clan borradas lógicamente. Los
